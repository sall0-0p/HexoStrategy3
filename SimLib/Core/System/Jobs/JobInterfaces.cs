...
public interface IJob<T> : ISystemJob
{
    ...
    void Execute(JobContext context, World world, CommandBuffer buffer, ref T component);
    ...
    void ISystemJob.Execute(JobContext context, World world, CommandBuffer buffer, Chunk chunk)
    {
        ...
        {
            Execute(context, world, buffer, ref span[i]);
        }
    }
}
...
public interface IJob<T1, T2> : ISystemJob
{
    ...
    void Execute(JobContext context, World world, CommandBuffer buffer, ref T1 c1, ref T2 c2);
    ...
    void ISystemJob.Execute(JobContext context, World world, CommandBuffer buffer, Chunk chunk)
    {
        ...
        for (var i = 0; i < chunk.Count; i++)
        {
            Execute(context, world, buffer, ref span1[i], ref span2[i]);
        }
    }
}
...
public interface IJob<T1, T2, T3> : ISystemJob
{
    ...
    void Execute(JobContext context, World world, CommandBuffer buffer, ref T1 c1, ref T2 c2, ref T3 c3);
    ...
    void ISystemJob.Execute(JobContext context, World world, CommandBuffer buffer, Chunk chunk)
    {
        ...
        for (var i = 0; i < chunk.Count; i++)
        {
            Execute(context, world, buffer, ref span1[i], ref span2[i], ref span3[i]);
        }
    }
}